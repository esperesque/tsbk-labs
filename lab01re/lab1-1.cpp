...
// Assignments
// 1a: Modify shader to get spots brighter than 1   ==DONE
// 1b: Implement a low-pass filter                  ==DONE
// 1c: Ping-ponging                                 ==DONE
// 1d: Bloom-filter                                 ==DONE
// 1e: Bloom-effect                                 ==DONE
...
GLuint phongshader = 0, plaintextureshader = 0, lpshader = 0, thresholdshader = 0, plusshader = 0;
...
void init(void)
{
    ...
    plusshader = loadShaders("plus.vert", "plus.frag");
...
//	glFlush(); // Can cause flickering on some systems. Can also be necessary to make drawing complete.
	...
	// Lowpass-filter and send to screen
	//runfilter(lpshader, fbo1, 0L, 0L);
